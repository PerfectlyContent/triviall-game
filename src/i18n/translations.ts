...
const he: Record<TranslationKey, string> = {
  ...
  'home.trivia': 'TRIVIA',
  'home.game': 'GAME',
  'home.tagline': 'משחק הוגן לכולם',
  'home.hostGame': 'אירוח משחק חדש',
  'home.joinGame': 'הצטרפות למשחק',
  'home.poweredBy': 'מופעל בינה מלאכותית',

  // Setup steps
  'setup.profile': 'פרופיל',
  'setup.mode': 'מצב',
  'setup.subjects': 'נושאים',
  'setup.settings': 'הגדרות',

  // Profile
  'setup.yourName': 'השם שלך',
  'setup.enterName': 'הכנס את שמך',
  'setup.ageGroup': 'קבוצת גיל',
  'setup.kid': 'ילד',
  'setup.adult': 'מבוגר',
  'setup.howOld': 'בן כמה את/ה?',
  'setup.chooseAvatar': 'בחר אווטאר',

  // Mode
  'setup.sameDevice': 'מכשיר משותף',
  'setup.sameDeviceDesc': 'העבירו את הטלפון ביניכם - מושלם למסיבות!',
  'setup.diffDevices': 'מכשירים נפרדים',
  'setup.diffDevicesDesc': 'שחקו אונליין עם קוד חדר',

  // Subjects
  'setup.allSubjects': 'כל הנושאים',
  'setup.selectAll': 'בחר הכל',
  'subject.Science': 'מדע',
  'subject.History': 'היסטוריה',
  'subject.Gaming': 'גיימינג',
  'subject.Movies': 'סרטים',
  'subject.Music': 'מוזיקה',
  'subject.Sports': 'ספורט',
  'subject.Nature': 'טבע',
  'subject.Food': 'אוכל',
  'subject.Travel': 'טיולים',
  'subject.PopCulture': 'תרבות פופ',
  'subject.Art': 'אמנות',
  'subject.Tech': 'טכנולוגיה',

  // Settings
  'setup.numRounds': 'מספר סיבובים',
  'setup.quick': 'מהיר',
  'setup.classic': 'קלאסי',
  'setup.epic': 'אפי',
  'setup.continue': 'המשך',
  'setup.createLobby': 'צור לובי',

  // Join
  'join.title': 'הצטרפות למשחק',
  'join.enterCode': 'הכנס קוד חדר',
  'join.next': 'הבא',
  'join.roomNotFound': 'החדר לא נמצא. בדקו את הקוד ונסו שוב.',
  'join.joining': 'מצטרף...',
  'join.joinGame': 'הצטרף למשחק',

  // Lobby
  'lobby.title': 'לובי המשחק',
  'lobby.shareCode': 'שתפו את הקוד עם חברים',
  'lobby.copied': 'הועתק!',
  'lobby.copyCode': 'העתק קוד',
  'lobby.rounds': 'סיבובים',
  'lobby.subjects': 'נושאים',
  'lobby.sameDevice': 'מכשיר משותף',
  'lobby.online': 'אונליין',
  'lobby.players': 'שחקנים',
  'lobby.addPlayer': '+ הוסף שחקן',
  'lobby.playerName': 'שם השחקן',
  'lobby.age': 'גיל',
  'lobby.cancel': 'ביטול',
  'lobby.add': 'הוסף',
  'lobby.startGame': 'התחל משחק',
  'lobby.needPlayers': 'צריך לפחות 2 שחקנים',
  'lobby.waitingHost': 'ממתינים שהמארח יתחיל את המשחק...',

  // Round
  'round.round': 'סיבוב',
  'round.yourTurn': 'התור שלך',
  'round.generating': 'יוצר שאלה...',
  'round.generatingYours': 'יוצר את השאלה שלך...',
  'round.waitingFor': 'ממתינים לתור של {name}...',
  'round.didYouKnow': 'הידעת?',
  'round.yourTurnIntro': 'התור שלך!',
  'round.playerTurn': 'התור של {name}',
  'round.getReady': 'התכוננו!',
  'round.watchWait': 'צפו והמתינו...',
  'round.isAnswering': '{name} עונה...',
  'round.difficulty': 'רמת קושי',
  'round.nextTurn': 'התור הבא עוד רגע...',
  'round.seeResults': 'צפה בתוצאות',
  'round.continue': 'המשך',
  'round.correct': 'נכון!',
  'round.notQuite': 'לא בדיוק!',

  // Results
  'results.tie': 'תיקו!',
  'results.wins': '{name} ניצח!',
  'results.pts': 'נק\'',
  'results.correct': 'נכונות',
  'results.streak': 'רצף',
  'results.playAgain': 'שחק שוב',
  'results.newGame': 'משחק חדש',
  'results.kid': 'ילד',
  'results.accuracy': 'דיוק',

  // Awards
  'award.hottestStreak': 'הרצף הלוהט',
  'award.longestStreak': 'רצף התשובות הארוך ביותר',
  'award.inARow': '{n} ברצף',
  'award.sharpshooter': 'צלף מדויק',
  'award.highestAccuracy': 'הדיוק הגבוה ביותר',
  'award.accuracyValue': '{n}% דיוק',
  'award.speedDemon': 'שד המהירות',
  'award.fastestAnswer': 'התשובה הנכונה המהירה ביותר',
  'award.speedValue': '{n} שנ\'',
